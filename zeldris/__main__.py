...
A modular group management bot with useful features. [ㅤ](https://telegra.ph/file/4d339f72dfe6e545efac5.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="Add Flare to Your Group 👥",
            url="t.me/Flare_Robot?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(
